export default {
    ...
    <button @click="updateSong" style="border-radius:20px; padding:10px; background-color:#db7093">Update Song</button>
    </div>`,
    data() {
        return {
            albums: [],
    ...
    methods: {
        async updateSong() {
            const songData = {
                ...
                date_added: this.song.date_added,
    ...
    async mounted() {
        ...
        console.log("value:",this.$route.params.id)
